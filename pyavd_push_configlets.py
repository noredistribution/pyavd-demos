...
if __name__ == "__main__":
    ...
    configlets = [
        CVEosConfig(file=f"/avd-labs/avd-evpn-l3ls-v3/intended/configs/{host['hostname']}.cfg", device=CVDevice(hostname=f"{host['hostname']}", serial_number=f"{host['serial_number']}", system_mac_address=f"{host['system_mac_address']}", _exists_on_cv=True))
